...
extern Wavetable wavtable1;
extern Wavetable wavtable2;
extern Wavetable wavtable3;
extern Wavetable wavtable4;
extern Wavetable wavtable5;
extern Wavetable wavtable6;
extern Wavetable wavtable7;
...
//ADC stuff
  ...
  wavetable_init(&wavtable1, crowtable_slower, 283); // now last arg as length of table=less than 512
  wavetable_init(&wavtable2, table_kahrs000, 160);
  wavetable_init(&wavtable3, table_fletcher000, 99);
  wavetable_init(&wavtable4, plaguetable_simplesir, 328);
  wavetable_init(&wavtable5, crowtable, 142);
  wavetable_init(&wavtable6, ourtable, 512);
  ...
  initLF(&LFxx);
  shimmer_init(&parry, &shimm);
  klglott88_init(&glotty, 48000, 400, 0.15, 1.0);
